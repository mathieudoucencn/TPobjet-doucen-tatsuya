...
public class Nourriture extends Objet implements Utilisable {
     ...
     */
    public Nourriture(Point2D p, int effet, int duree, String caract){
        super(p);
        this.effet = effet;
        this.duree = duree;
        this.caract = caract;
    ...
    /**
     * Utilisation de la Nourriture par un joueur.
     * Applique l'effet sur une caractéristique pendant une durée définie.
